...
// agent's rules or the team objectives, and creating, renaming or deleting an
// agent (design §6).
var AskRules = []string{AskRule, "Bash(sunstack hire *)", "Bash(sunstack rename *)", "Bash(sunstack fire *)"}
